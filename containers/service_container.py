...
class ServiceContainer(containers.DeclarativeContainer):
    ...
    student_service = providers.Factory(StudentService, db_repository=cassandra_repository, cache_repository=redis_repository, search_repository=cassandra_repository, message_broker_repository=kafka_repository)
    user_service = providers.Factory(UserService, db_repository=cassandra_repository, cache_repository=redis_repository, search_repository=cassandra_repository)